...
public abstract class ContactAccessor {
    ...
    public static ContactAccessor getInstance2() {
        /*
         ...
         */
        if (sInstance == null) {
            int sdkVersion = Build.VERSION.SDK_INT;       // Cupcake style
            if (sdkVersion < Build.VERSION_CODES.ECLAIR) {
                //当SDk<5时
                sInstance = new ContactAccessorSdk3_4();
            } else {
    ...
    public static ContactAccessor getInstance() {
        ...
        if (sInstance == null) {
            ...
            if (sdkVersion < Build.VERSION_CODES.ECLAIR) {
                //当SDk<5时
                className = ContactAccessorSdk3_4.class.getName();
            } else {
                className = ContactAccessorSdk5.class.getName();
            }
